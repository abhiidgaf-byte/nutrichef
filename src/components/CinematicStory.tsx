...
export const CinematicStory = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      .to('.dashboard-data-1', { background: 'rgba(16, 185, 129, 0.15)', borderColor: 'rgba(16, 185, 129, 0.3)', duration: 2 }, '-=2')
      ...
      .to('.dashboard-status', { textContent: 'Chef Assigned', color: '#10b981', duration: 1.5 })
  ...
  return (
    <div ref={containerRef} className="relative h-screen bg-black overflow-hidden flex items-center">
      ...
      <div className="absolute top-1/2 left-1/4 w-[600px] h-[600px] bg-emerald-500/5 rounded-full blur-[160px] -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-10 right-1/4 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div className="relative w-full h-[480px] flex items-center">
          ...
          <div className="order-text absolute inset-0 flex flex-col justify-center opacity-0 pointer-events-none">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-[0.4em] mb-6 w-fit">
          ...
          <div className="journey-content absolute inset-0 flex flex-col justify-center opacity-0 pointer-events-none">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/60 text-[10px] font-black uppercase tracking-[0.4em] mb-6 w-fit">
            ...
            <p className="text-white/40 text-lg font-light leading-relaxed max-w-lg mb-8">
            ...
            <div className="flex flex-wrap gap-3 max-w-md">
              {['Condition: Tailored', 'Goal: Longevity', 'Preference: Organic', 'Activity: Optimized'].map((q, i) => (
                <div key={i} className="journey-question opacity-0 scale-90 px-4 py-2 bg-white/5 rounded-xl border border-white/10 text-xs font-bold text-white/80">
                  {q}
                </div>
              ))}
            </div>
          ...
          <div className="delivery-content absolute inset-0 flex flex-col justify-center opacity-0 pointer-events-none">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-6 leading-tight">
              Culinary Luxury. <br />
              <span className="text-emerald-400">Arriving Daily.</span>
            </h2>
            <p className="text-white/40 text-xl font-light leading-relaxed max-w-lg">
          ...
          <div className="final-statement absolute inset-0 flex flex-col justify-center opacity-0 pointer-events-none">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-[0.85] mb-6">
              Your Personal <br />
        ...
        <div className="relative w-full flex items-center justify-center">
          <div 
            ref={dashboardRef}
            className="order-dashboard w-full max-w-lg bg-white/[0.02] backdrop-blur-3xl rounded-[48px] border border-white/10 p-10 md:p-12 shadow-[0_40px_120px_rgba(0,0,0,0.8)] flex flex-col justify-between opacity-0 dashboard-bg relative overflow-hidden"
          >
            {/* Card Header */}
            <div className="flex justify-between items-start mb-10">
              <div>
                <p className="text-white/20 text-[10px] uppercase tracking-[0.5em] mb-3 font-black">Metabolic Engine</p>
                <h3 className="text-3xl font-bold tracking-tighter dashboard-status text-white/50">Calibrating...</h3>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-10">
              <div className="p-6 bg-white/5 rounded-[32px] border border-white/10 dashboard-data-1 flex flex-col justify-center">
                <p className="text-white/20 text-[10px] font-black uppercase tracking-[0.3em] mb-3">Calibration</p>
                <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                   <div className="h-full bg-emerald-500 dashboard-progress-1 w-0" />
                </div>
              </div>
              
              <div className="p-6 bg-white/5 rounded-[32px] border border-white/10 flex flex-col justify-center">
                <p className="text-white/20 text-[10px] font-black uppercase tracking-[0.3em] mb-1">Longevity Score</p>
                <p className="text-white text-5xl font-black tracking-tighter dashboard-score">8.4</p>
              </div>
            </div>

            {/* Delivery Alert Panel */}
            <div className="p-6 bg-white/5 rounded-[32px] border border-white/10 opacity-0 dashboard-delivery translate-y-6 mb-8 flex items-center justify-between">
              <div>
                <p className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.4em] mb-1">Logistics</p>
                <p className="text-white text-xl font-bold tracking-tight">Daily Pack Delivered</p>
              </div>
              <CheckCircle2 className="w-8 h-8 text-emerald-400" />
            </div>

            {/* Live Telemetry Bar */}
            <div className="p-5 bg-emerald-500/5 border border-emerald-500/10 rounded-[28px] flex items-center gap-4">
            ...
            {/* Soft Interior Glow */}
            <div className="absolute -right-16 -bottom-16 w-64 h-64 bg-emerald-500/5 rounded-full blur-[80px] pointer-events-none" />
          </div>
        </div>
