...
export const TrustBar = () => {
  return (
    <section className="bg-stone-50 py-24 border-y border-stone-100 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center justify-center text-center gap-6">
          ...
          <div className="space-y-3">
            <h3 className="font-serif text-stone-900 font-semibold text-3xl md:text-4xl tracking-tight">
